        ...
        <div className="min-w-0 space-y-6">
          ...
          <Panel id="lokasi" title="Lokasi dan Maps">
            ...
            <p className="rounded-lg bg-blush-50 p-4 text-sm leading-6 text-gray-500">
              Jangan biarkan latitude dan longitude berisi 0 atau 0.000000. Isi koordinat asli dalam format desimal,
              atau kosongkan keduanya agar maps memakai nama lokasi dan alamat.
            </p>
          </Panel>
